...
import { ArrowRight, Sparkles, CheckCircle2, Code, Search, Share2, Bot } from 'lucide-react';
...
const valueStrip = [
    ...
    { label: 'SEO & Organic Growth', icon: Search },
    { label: 'Social Media Marketing', icon: Share2 },
    { label: 'AI Chat & Call Support', icon: Bot },
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-8 flex flex-col items-start text-left">
                            <StaggerContainer className="space-y-8">
                                ...
                                <FadeIn>
                                    <h1 className="text-fluid-h1 font-black tracking-tight text-foreground leading-[1] md:leading-[0.95]">
                                        Grow Your Business Faster with{' '}
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-white animate-gradient">
                                            AI-Powered Digital Solutions.
                                        </span>
                                    </h1>
                                </FadeIn>
                                ...
                                <FadeIn className="max-w-2xl text-muted-foreground text-fluid-body font-light leading-relaxed">
                                    We help startups and businesses build high-performance websites, improve search rankings, automate customer support, and scale operations with modern digital and AI solutions.
                                </FadeIn>

                                <FadeIn className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
